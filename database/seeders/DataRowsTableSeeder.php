...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $carDataType = DataType::where('slug', 'cars')->firstOrFail();
        ...
        $dataRow = $this->dataRow($carDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'number',
                'display_name' => __('voyager::seeders.data_rows.id'),
        ...
        $dataRow = $this->dataRow($carDataType, 'brand');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text',
                'display_name' => __('Brand'),
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
        ...
        $dataRow = $this->dataRow($carDataType, 'model');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'text',
        ...
        $dataRow = $this->dataRow($carDataType, 'production_year');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'number',
                'display_name' => __('Production Year'),
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
        ...
        $dataRow = $this->dataRow($carDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.created_at'),
        ...
        $dataRow = $this->dataRow($carDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'timestamp',
                'display_name' => __('voyager::seeders.data_rows.updated_at'),
